...
import { Button, ButtonGroup } from "gs-awds";
...
export default function ButtonExample() {
  ...
  return (
    <div>
      <div className="flex flex-col gap-y-5 bg-content-basic">
        <div>
        ...
        <div className="mb-2 flex items-center gap-x-2">
          <Button variant="ghost" primary circle size="icon">
            <svg
              className="size-6"
              viewBox="0 0 24 24"
              fill="none"
          ...
          <Button variant="ghost" circle size="icon">
            <svg
              className="size-4"
              viewBox="0 0 24 24"
              fill="none"
